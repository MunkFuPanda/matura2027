...
insert into person
values
    (102, 'Haendel', 'Georg Friedrich', 'London', 'GB');
insert into person
values
...
values
    (1, 1, '07.04.2013', '08.04.2013', 'Wien', 3, 103);
insert into kveranst
values
    (1, 2, '23.06.2014', '24.06.2014', 'Moskau', 4, 114);
insert into kveranst
values
    (1, 3, '10.04.2015', '11.04.2015', 'Paris', 3, null);
insert into kveranst
values
    (2, 1, '09.10.2013', '11.10.2013', 'Wien', 4, 104);
insert into kveranst
values
    (3, 1, '17.11.2013', '17.11.2013', 'Moskau', 3, 103);
insert into kveranst
values
...
insert into kveranst
values
    (5, 1, '18.05.2014', '20.05.2014', 'Paris', 3, 101);
insert into kveranst
values
...
insert into kveranst
values
    (7, 2, '14.09.2015', '18.09.2015', 'Muenchen', 4, 116);
