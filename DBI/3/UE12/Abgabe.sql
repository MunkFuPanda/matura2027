...
insert into Schueler (Nachname, Vorname, KlasseID) values
	('Ackermann', 'Bernd', 1),
	('Demeter', 'Aron', 1),
	('Eitzenberger', 'Paul', 1),
	('Kappler', 'David', 1),
...
select (cast((rand()*100) as int)) % 75 + 1;
...
while @i < @max
begin
    insert into Wichtel (VonID, FuerID, GeschenkID) values 
